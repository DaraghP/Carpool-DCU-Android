...
# lets show step by step what a driver will do same for passenger
# i'll try to basically make a trip then cut the video where i go as passenger to look for a trip
# hmm idm we could try it, i can make zoom meeting on phone
# 
